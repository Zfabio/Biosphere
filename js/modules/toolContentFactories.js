  ...
  return `
    <div class="bio-tool-wrapper">
        ...
        <div class="tool-header-info">
            ...
            <p>Predict phenotypic and genotypic ratios for monohybrid crosses.</p>
        </div>

        <div class="tool-inputs-grid">
            <div class="input-group">
                <label>Parent 1 Alleles</label>
                <input type="text" id="punnett-p1" value="Aa" maxlength="2" placeholder="e.g. Aa">
            </div>
            <div class="input-group">
                <label>Parent 2 Alleles</label>
                <input type="text" id="punnett-p2" value="Aa" maxlength="2" placeholder="e.g. Aa">
            </div>
        </div>

        <div class="punnett-grid-container">
            <div class="punnett-label-top" id="punnett-top-alleles">
                <span>A</span><span>a</span>
            </div>
            <div class="punnett-label-left" id="punnett-left-alleles">
                <span>A</span><span>a</span>
            </div>
            <div class="punnett-grid" id="punnett-main-grid">
        ...
        <div class="results-stats">
            ...
            <div class="stat-grid" id="punnett-stats-grid">
                <div class="stat-card">
                    <span class="label">Genotypic Ratio</span>
                    <span class="value" id="genotypic-ratio">1:2:1</span>
                </div>
                <div class="stat-card">
                    <span class="label">Phenotypic Ratio</span>
                    <span class="value" id="phenotypic-ratio">3:1</span>
                </div>
            </div>
        </div>
    </div>
